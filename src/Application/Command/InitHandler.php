...
class InitHandler implements CommandHandlerInterface
{
    ...
    private function readData(string $refName, string $ext) : array
    {
        $majorReleases = array(
            ...
            'standard' => array(
                'classes'    => array('4', '5', '7'),
                'constants'  => array('4', '5', '7', '71', '72', '73', '74', '80'),

...
* a Symfony console application to handle data (json files) of the SQLite3 database is provide on CLI API
...
|---------|------------|-------------------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|
| 3.0     | 2020-12-dd |                   | 5.2.17  | 5.3.29  | 5.4.45  | 5.5.38  | 5.6.40  |  7.0.33 |  7.1.30 |  7.2.34 |  7.3.24 |  7.4.12 |  8.0.0  |
|         |            | apcu 5.1.19       |         |         |         |         |         |         |         |         |         |         |         |
